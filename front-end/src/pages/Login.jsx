...
const Login = () => {
    ...
    const loginUser = async (e) => {
        e.preventDefault();
        const response = await api.post("users/login/", { email: email, password: password, display_name: displayname });
    ...
    return (
        <>
            <div className="d-flex justify-content-center align-items-center min-vh-100 tw-bg-light-gray">
                <form className="w-100 max-w-lg bg-white shadow-lg rounded px-4 pt-3 pb-3 mb-4" onSubmit={loginUser}>
                    <div className="mb-3">
